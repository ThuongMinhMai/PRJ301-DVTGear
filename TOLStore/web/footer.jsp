...
<footer class="bg-dvt-black-2 py-12">
    <div class="container bg-dvt-black-2 mx-auto max-w-7xl w-11/12">
        <div class="row grid grid-cols-12">
            <div
                class="footer-col col-span-12 w-full mb-8 p-3 lg:col-span-3 md:col-span-6 sm:col-span-12"
                >
                <h4
                    class="text-2xl w-full font-bold text-white capitalize mb-[30px] relative"
                    >
                    Công ty
                </h4>
                <ul>
                    <li>
                        <a
                            class="text-lg capitalize text-gray-500 mb-2 no-underline font-light block transition-all ease-in-out hover:text-white hover:pl-2"
                            href="#"
                            >Về chúng tôi</a
                        >
                    </li>
            ...
            <div
                ...
                >
                <h4
                    class="text-2xl font-bold text-white capitalize mb-[30px] relative"
                    >
                    Hỗ Trợ
                </h4>
                <ul>
                    ...
                    <li>
                        <a
                            class="text-lg capitalize text-gray-500 md-2 no-underline font-light block transition-all ease-in-out hover:text-white hover:pl-2"
                            href="#"
                            >Quay lại</a
                        >
                    </li>
            ...
            <div
                ...
                <div class="social-links">
                    <a
                        class="inline-block bg-white/20 h-10 w-10 text-center leading-10 rounded-[50%] text-white hover:bg-primary hover:text-white transition-all ease-in-out"
                        href="#"
