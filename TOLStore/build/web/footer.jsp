    ...
    <div class="container bg-dvt-black-2 mx-auto max-w-7xl w-11/12">
        <div class="row grid grid-cols-12">
            <div class="footer-col col-span-12 w-full mb-8 p-3 lg:col-span-3 md:col-span-6 sm:col-span-12">
                ...
                <ul>
                    <li>
                        <a class="text-lg capitalize text-gray-500 mb-2 no-underline font-light block transition-all ease-in-out hover:text-white hover:pl-2" href="#">
                            Về chúng tôi
                        </a>
                    </li>
                    <li>
            ...
            <div class="footer-col col-span-12 w-full mb-8 p-3 lg:col-span-3 md:col-span-6 sm:col-span-12">
                ...
                <ul>
                    ...
                    <li>
                        <a class="text-lg capitalize text-gray-500 md-2 no-underline font-light block transition-all ease-in-out hover:text-white hover:pl-2" href="#">
                            Quay lại
                        </a>
                    </li>
                    <li>
            ...
            <div class="footer-col col-span-12 w-full mb-8 p-3 lg:col-span-3 md:col-span-6 sm:col-span-12">
                ...
                <div class="social-links">
                    <a class="inline-block bg-white/20 h-10 w-10 text-center leading-10 rounded-[50%] text-white hover:bg-primary hover:text-white transition-all ease-in-out" href="#">
