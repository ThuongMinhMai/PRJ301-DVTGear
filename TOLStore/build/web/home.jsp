...
<div class="flex p-6 gap-6 mt-24">
    <div id="banner_nav" style="height: calc((100vw - 357px) / 2.55)"
        ...
        <nav class="grid grid-cols-2 relative mb-4">
            <div id="nav_category" class="col-span-1 text-center py-4 cursor-pointer font-bold bg-dvt-black-2 rounded-tr-3xl">
                Danh Mục
            </div>
    ...
    <div class="relative justify-center grid grid-cols-12 gap-5 w-11/12 max-w-6xl mx-auto">
        ...
        <div class="bg-dvt-black-2 flex flex-col rounded-3xl overflow-hidden cursor-pointer col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3">
            <a href="/store/products?id=<%= product.getId()%>" class="w-full overflow-hidden relative aspect-square">
                ...
                <img class="w-full h-full object-cover bt-[20px] transition duration-300 ease-linear hover:scale-125" src="<%=imageUrl%>" alt="product" />
            ...
            <div onclick="addToCart(<%= product.getId()%>, 1,<%= product.getStorage()%>)" class="mt-auto mx-auto px-4 py-2 rounded-[30px] bg-primary border-none uppercase cursor-pointer mb-4 hover:opacity-80">
                Thêm vào giỏ hàng
            </div>
        </div>
        <% }%>
