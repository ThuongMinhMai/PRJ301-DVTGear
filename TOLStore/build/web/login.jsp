                ...
                <div class="form-value">
                    <form action="/store/login" method="POST" class="flex justify-center flex-col items-center">
                        ...
                        <div class="relative flex-row justify-center items-center mx-0 my-4 w-80 border-b-2 border-white">
                            ...
                            <input class="w-full h-5 bg-transparent border-none outline-none text-base text-white" type="text" name="username" required autocomplete="off" />
                            <label class="absolute text-white top-[10%] left-0 mb-[-10px] pointer-events-none transition-all" for="">Username</label>
                        </div>
                        <div class="relative flex-row justify-center items-center mx-0 mt-4 w-80 border-b-[2px] border-white">
                            ...
                            <input class="w-full h-5 bg-transparent border-none outline-none text-base text-white" type="password" name="password" required />
                            <label class="absolute text-white top-[10%] left-0 mb-[-10px] pointer-events-none transition-all" for="">Password</label>
                        </div>
                        ...
                        <% }%>
                        <button class="w-[100%] mt-3 h-10 rounded-md mt-4 bg-primary border-none outline-none cursor-pointer text-xl text-white font-semibold login-button hover:opacity-70">Login</button>
                        <div class="text-xl text-white text-center mt-2 flex flex-row justify-center items-center register">
                            <p>
                                Don't have an account?<a class="no-underline text-white font-semibold ml-2 hover:underline hover:text-primary" href="/store/register">Register</a>
                            </p>
                        </div>
                    </form>
