        ...
        <div class="form-value">
          <form action="/store/login" method="POST" class="flex justify-center flex-col items-center">
            ...
            <div class="relative flex-row justify-center items-center mx-0 mt-4 w-80 border-b-[2px] border-white">
              ...
              <input class="w-full h-5 bg-transparent border-none outline-none text-base text-white" type="password"
          ...
          <div class="mx-auto py-2 px-4 rounded-md bg-white flex items-center justify-center gap-2 cursor-pointer hover:opacity:70"
