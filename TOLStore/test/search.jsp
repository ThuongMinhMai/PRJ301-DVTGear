...
<div id="searchPage" class="relative pb-16 mt-32 w-11/12 max-w-6xl mx-auto">
    ...
    <div class="flex justify-center">
        ...
        <div class="sort-icon cursor-pointer" onclick="sortProductsBy('nameDesc')">
            <div class="sortNameDesc flex items-center bg-dvt-black-2 justify-center w-14 h-14 m-2 rounded-full hover:bg-primary">
        ...
        <div class="sort-icon cursor-pointer" onclick="sortProductsBy('')">
            <div class="sortNewest flex items-center bg-dvt-black-2 justify-center w-14 h-14 m-2 rounded-full hover:bg-primary">
        ...
        <div class="sort-icon cursor-pointer" onclick="sortProductsBy('priceDesc')">
            <div class="sortPriceDesc flex items-center bg-dvt-black-2 justify-center w-14 h-14 m-2 rounded-full hover:bg-primary">
    ...
    <c:set var="totalProducts" value="${requestScope.itemsCount}"/>
